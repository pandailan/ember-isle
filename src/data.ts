...
export const CHESTS: Record<string, ChestLoot> = {
  "3:11,2":{gold:55, potions:1, note:"a peddler's abandoned pack"},
  "3:2,7": {gold:70, potions:1, note:"a barrow-stone cache", items:["relic"]},
  "3:18,5":{gold:40, potions:1, note:"a wave-washed strongbox"},
  ...
  "4:12,2":{gold:90, potions:1, note:"a smuggler's strongbox", cards:[["relic","emberheart"]]},
  "4:12,5":{gold:60, potions:2, note:"a tide-buried sea chest", cards:[["event","mappage"]]},
